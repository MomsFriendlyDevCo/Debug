...
export default function DebugFactory(prefix) {
	...
	debug.deconstruct = function(v) {
		...
		if (vType == 'object') { // Try to flatten objects
			...
			return debug._highlights.reduce((str, highlight) =>
				str.replace(highlight.match, (...matches) =>
					highlight.prefix
	...
	* @property {function} highlight Function to enclose the match within - usually a pointer to `colors.*`
	...
	* @param {function} color The color to apply
